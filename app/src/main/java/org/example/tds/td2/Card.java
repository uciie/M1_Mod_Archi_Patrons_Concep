...
//import org.example.cards.cours3.Card.Suit;
...
public class Card {
        ...
        public Color color() {
            switch (this) {
                ...
                case CLUBS, SPADES:
                    return Color.BLACK;
                default:
                    throw new IllegalArgumentException("Unknown suit: " + this);
            }
        }
    }
    ...
    public Suit getSuit() {
        // Get the suit by using ordinal and values
        int suitIndex = carte.ordinal() / 13;
        return Suit.values()[suitIndex];
    }

    public Rank getRank() {
        // Get the rank by using ordinal and values
        int rankIndex = carte.ordinal() % 13;
