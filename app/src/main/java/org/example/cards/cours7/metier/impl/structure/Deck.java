...
import org.example.cards.cours7.metier.api.ShufflableCardSource;
import org.example.cards.cours7.metier.api.Sortable;
...
public class Deck implements ShufflableCardSource, Sortable<ICard> {
    ...
    // on n'a pas mis final ici car on a un constructeur par recopie
    // de plus, final gère la référence mais pas le contenu de la collection
     ...
     * Package level + factory (Croupier) removed here for simplicity of presentation.
     */
    public Deck() {
